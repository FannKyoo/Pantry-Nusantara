...
<head>
    ...
    <title>PantryNusantara - Belanja</title>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 col-md-2 col-md-6 col-xs-6">
                        <a href="index-2.html" class="PantryNusantara-logo"><img src="assets/images/organic-3.png" alt="PantryNusantara logo" width="135" height="34"></a>
                    </div>
            ...
            <div class="container">
                                ...
                                <ul class="contact-lines">
                                    ...
                                    <li>
                                        <p class="info-item">
                                            ...
                                            <b class="desc">Phone: (+62) 0813-5930-3621</b>
                                        </p>
                                    </li>
                                    <li>
                                        <p class="info-item">
                                    ...
                                    <li>
                                        <p class="info-item">
                                            ...
                                            <b class="desc">Hours: Every Day : 8.00Am until 4.00Pm</b>
                                        </p>
                                    </li>
                                </ul>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-sm-6 col-xs-12">
                       <div class="copy-right-text"><p><a href="templateshub.net">FannKyoo</a></p></div>
