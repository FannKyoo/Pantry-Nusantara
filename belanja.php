...
<head>
    ...
    <title>Belanja - PantryNusantara</title>
                    ...
                    <div class="col-lg-9 col-md-8 padding-top-2px">
                        ...
                        <div class="live-info">
                            <p class="telephone"><i class="fa fa-phone" aria-hidden="true"></i><b
                                    class="phone-number">(+62) 813-5930-3621</b></p>
                            <p class="working-time">Senin-Jumat : 08.00-20.00</p>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <ul class="contact-lines">
                                    ...
                                    <li>
                                        <p class="info-item">
                                            ...
                                            <b class="desc">Jam Buka: Senin - Jumat</b>
                                        </p>
                                    </li>
                                </ul>
                            </div>
